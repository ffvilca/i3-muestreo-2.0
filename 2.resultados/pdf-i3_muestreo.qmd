...
```{r echo=FALSE,fig.align='center',fig.cap="Tabla 1: Probabilidades de Selección y Factores de Expansión según Zona, Sexo y cat-edad"}
...
knitr::kable(tabla_datos1, digits = 6)
```
